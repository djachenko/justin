...
class Registry(Generic[E, K]):
    ...
    def read(self) -> None:
        ...
        with self.__path.open() as entries_json_file:
            ...
            self.__entries = [self.__type.from_json(person_json) for person_json in
                              entries_json[Registry.__ENTRIES_KEY]]
    ...
    def save(self) -> None:
        ...
        entries_json[Registry.__ENTRIES_KEY] = [entry.as_json() for entry in self.__entries]
